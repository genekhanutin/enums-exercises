...
class FindUsingMaxByTest < Minitest::Test
  ...
  def test_array_with_the_most_items
    ...
    # write code here
    biggest_array = arrays.max_by {|array| array.size}
  ...
  def test_most_programmers
    ...
    # write code here
    most_programmers = programmers.max_by {|language| programmers[language]}
  ...
  def test_fewest_programmers
    ...
    # write code here
    fewest_programmers = programmers.max_by {|language, people| -programmers[language].count}
