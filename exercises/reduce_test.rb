...
class ReduceTest < Minitest::Test
  ...
  def test_divide_560_by_a_bunch_of_numbers
    ...
    # Your code goes here
    result = numbers.reduce(560) {|value, number| value / number}
  ...
  def test_subtract_smallest_values_from_100
    ...
    # Your code goes here
    result = elements.reduce(100) {|value, element| value - element.size}
  ...
  def test_add_all_the_second_values_together
    ...
    # initial value is 0
    # Your code goes here
    result = elements.reduce(0) {|value, element| value + element[-1]}
